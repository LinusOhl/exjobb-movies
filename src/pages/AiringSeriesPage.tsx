...
import useTVOnTheAir from "../hooks/series/useTVOnTheAir";
import {
  Box,
  Button,
  Flex,
...
const AiringSeriesPage = () => {
  const [searchParams, setSearchParams] = useSearchParams();
  const navigate = useNavigate();

  const pageParam = searchParams.get("page") ?? "1";

  const { data: shows, isLoading } = useTVOnTheAir(pageParam);
...
export default AiringSeriesPage;
